...
<!--[if gt IE 8]><!-->
<html class="no-js wf-bree-n4-active wf-bree-n7-active wf-breeserif-n7-active wf-breeserif-n3-active wf-active" lang="">
<!--<![endif]-->
...
<head>
    ...
    <style type="text/css">@font-face {
        ...
        @font-face {
            ...
            src: url(https://use.typekit.net/af/31d37f/00000000000000000001441b/27/l?subset_id=2&fvd=n7&v=3) format("woff2"), url(https://use.typekit.net/af/31d37f/00000000000000000001441b/27/d?subset_id=2&fvd=n7&v=3) format("woff"), url(https://use.typekit.net/af/31d37f/00000000000000000001441b/27/a?subset_id=2&fvd=n7&v=3) format("opentype");
            font-weight: 700;
            font-style: normal;
        }
    ...
    <header class="row" id="header">
        ...
        <a href="https://coder-forge.com">
            <h1><img src="/img/profile.jpg"
                     class="logo img-rounded" height="160" width="160" alt="Profile Image"/>
                ...
                <article>
                    ...
                    <div class="rich-text">
                        <p>
                            ...
                            the structure, CSS adds the styling to websites. Although not programming languages, every
                            developer
                        ...
                        <div class="list-group">
                            <a href="https://www.w3schools.com/html/default.asp" target="_blank"
                               class="list-group-item">W3Schools
                                Tutorial on HTML</a>
                    ...
                    <div class="rich-text">
                        <p>
                            ...
                            used to add interactivity and responsiveness to websites. A great programming language to
                            learn and build
                        ...
                        <div class="list-group">
                            ...
                            <a href="https://javascript.info/" target="_blank" class="list-group-item">Javascript.info
                                Tutorial</a>
                    ...
                    <div class="rich-text">
                        <p>
                            ...
                            such as scripting, development of web applications, machine learning and security. Many
                            people pick up
                        ...
                        <div class="list-group">
                            <a href="https://docs.python.org/3/tutorial/index.html" target="_blank"
                               class="list-group-item">Oficial
                                Python.org Tutorial</a>
                            <a href="https://www.sololearn.com/" target="_blank" class="list-group-item">SoloLearn
                                Website</a>
                    ...
                    <div class="rich-text">
                        <p>
                            Java is a general purpose, object-oriented programming language. It has a <i>write
                                once, run anywhere</i> approach, where the code writen in one environment will run in
                            any other provided
                            it has a Java Virtual Machine. Java is heavily used in client-server communication and it's
                            also used for
                        ...
                        <div class="list-group">
                            ...
                            <a href="https://hi.hyperskill.org/projects3" target="_blank" class="list-group-item">JetBrains
                                Academy
                                Course</a>
                            <a href="https://beginnersbook.com/java-tutorial-for-beginners-with-examples/"
                               target="_blank"
