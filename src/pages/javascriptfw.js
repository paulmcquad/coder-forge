...
export default function javascriptfw() {
return (
	<div>
...
<main class="row">
    ...
    <article class="col-8 text-left">
        <h2 class="text-3xl font-bold">JavaScript Frameworks:</h2>
        ...
        <h3 class="text-2xl font-bold">React</h3>
                ...
                <h3 class="text-2xl font-bold">Vue.js + Vuetify</h3>

                <div class="rich-text">
                  <p>
                    <b>Vue.js</b> (commonly referred to as Vue; pronounced /vjuː/, like "view")
                    ...
                    the active core team members coming from various companies such as
                    Netlify and Netguru.
                  </p>
                  <p>
                    <b>Vuetify</b> is a Vue UI Library with beautifully handcrafted Material Components.
                    No design skills required — everything you need to create amazing applications
                ...
                <h3 class="text-2xl font-bold">Angular</h3>
