...
<main class="row">
    <div>
              ...
              <figure class="md:flex rounded-xl md:p-8 dark:bg-slate-800">
                {/* <img class="w-48 h-48 md:w-48 md:h-auto md:rounded rounded-full mx-auto" src="https://coderforge.io/assets/Coders/Alan.jpg" alt="head coderforger" width="384" height="512"/> */}
                <div class="pt-6 md:p-8 text-left md:text-left space-y-4">
                    <blockquote>
                    <p class="text-lg font-medium">
